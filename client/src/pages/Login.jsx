        ...
        <p className="font-inter mt-2 font-light">Sign in / Sign up</p>
           ...
           <p className="text-[10px] font-w font-light">Name</p>       
              ...
              <div className="flex flex-col w-full items-center">
                  <button className="bg-[#F09C67] w-full h-8 rounded-full font-extralight text-white text-opacity-80 text-sm font-inter">Sign in / Sign up</button>
                  <p className="flex mt-6 text-[10px] text-[#F09C67] font-inter font-extralight self-center text-opacity-80">Only View the Menu</p>
              </div>
      </div>
    </div>
  );
